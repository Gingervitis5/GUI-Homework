...
public class OptionsLayoutController extends Dialog<ButtonType>{
    ...
    public OptionsLayoutController() throws IOException{
        ...
        mOkButt = new ButtonType("Ok", ButtonData.OK_DONE);
        
        ButtonType cancelButt = new ButtonType("Cancel", ButtonData.CANCEL_CLOSE);
        ...
        initialize(false, false, false, 8, "");
    }  
    ...
    public void initialize(boolean dateDisplayed,boolean italicsOn,boolean boldOn,
                            int fontSize,String string){
        mSettings = ApplicationSettings.createSettings(dateDisplayed, italicsOn, boldOn, fontSize, string);
    }
